...
>
> **开发者手册：** <https://docs.qgis.org/3.40/en/docs/pyqgis_developer_cookbook/>
>
> **Python API 参考：** <https://qgis.org/pyqgis/3.40/>
>
...
10. **QGIS 版本兼容**：部分 API 在不同版本间有变化，建议使用 3.40 LTR 以获得稳定接口。
...
- **PyQGIS 开发者手册（3.40）：** <https://docs.qgis.org/3.40/en/docs/pyqgis_developer_cookbook/>
- **PyQGIS API 参考（3.40）：** <https://qgis.org/pyqgis/3.40/>
- **QGIS 文档仓库：** <https://github.com/qgis/QGIS-Documentation>
- **QGIS 用户手册：** <https://docs.qgis.org/3.40/en/docs/user_manual/>
- **PyQGIS 速查表：** <https://docs.qgis.org/3.40/en/docs/pyqgis_developer_cookbook/cheat_sheet.html>
