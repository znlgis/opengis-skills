---
name: 3d-skills
description: "Use when working with 3D Gaussian Splatting (3DGS), .ply model cleanup/compression/publishing, interactive 360-degree panorama visualization and virtual tours, or AEC/BIM 3D data processing. Index of 3 skills: SuperSplat, Photo-Sphere-Viewer, and Ara3D-SDK."
tags:
  - 3d
  - gaussian-splatting
  - 3dgs
...
本分类涵盖 **3D / 三维可视化 / 三维数据处理 / 360° 全景** 相关的开源项目技能，涵盖 **3D 高斯泼溅（3DGS）** 这一新型实时辐射场表达方法的工程化工具链，面向 **AEC/BIM** 的高性能 .NET 三维数据引擎，以及基于 Three.js 的 **Web 360° 全景查看器**。
